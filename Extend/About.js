    ...
    <section className="w-full flex flex-col gap-12 max-w-screen-md pt-2 ">
     <div className="flex flex-col items-center gap-10">
        ...
        <ul className="flex flex-wrap gap-10 justify-center skill-list items-center">
          ...
          <li><Image src={saas} alt="saas" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">Saas/Scss</span></li>
          <li><Image src={jscript} alt="jscript" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">Javascript</span></li>
          <li><Image src={react} alt="react" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">React</span></li>
          <li><Image src={nextjs} alt="nextjs" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">Next Js</span></li>
          <li><Image src={git} alt="git" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">Git</span></li>
          <li><Image src={clang} alt="clang" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">C</span></li>
          <li><Image src={cplus} alt="cplus" width={70} height={75}/><span className="bg-gray-200 py-1 px-2 rounded-md">C++</span></li>
